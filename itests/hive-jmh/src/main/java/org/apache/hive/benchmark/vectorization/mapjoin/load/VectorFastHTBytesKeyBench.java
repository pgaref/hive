...
public class VectorFastHTBytesKeyBench {
  ...
  public static class HashMultiSetSmallFastVectorBench extends BytesKeyBase {
    @Setup
    public void setup() throws Exception {
      System.out.println("Do Setup");
  ...
  public static class HashSetLargeFastVectorBench extends BytesKeyBase {
    @Setup
    public void setup() throws Exception {
      System.out.println("Do Setup");
  ...
  public static class HashSetSmallFastVectorBench extends BytesKeyBase {
    @Setup
    public void setup() throws Exception {
      System.out.println("Do Setup");
  ...
  public static class HashMapLargeFastVectorBench extends BytesKeyBase {
    @Setup
    public void setup() throws Exception {
      System.out.println("Do Setup");
  ...
  public static class HashMapSmallFastVectorBench extends BytesKeyBase {
    @Setup
    public void setup() throws Exception {
      System.out.println("Do Setup");
